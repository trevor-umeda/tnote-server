package com.tumeda.tnote;

import com.tumeda.tnote.config.ApplicationProperties;
import com.tumeda.tnote.config.DefaultProfileUtil;
...
public class TnoteserverApp {
    ...
    public TnoteserverApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes tnoteserver.
     * <p>
